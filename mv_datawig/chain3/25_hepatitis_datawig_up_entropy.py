...
# CSV 파일 경로 설정
result_csv_path = '/userHome/userhome2/hyejin/test/res/chain3/up_25_hepatitis_datawig_method_res.csv'
...
def main():
    ...
    sorted_columns = sorted(entropies, key=entropies.get, reverse=True)
