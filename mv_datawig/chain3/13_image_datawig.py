...
# CSV 파일 경로 설정
result_csv_path = '/userHome/userhome2/hyejin/test/res/chain3/13_segmentation_datawig_method_res.csv'
    ...
    for iteration in range(num_iterations):
        ...
        for col in sorted_columns:  # entropy가 낮은 순서대로 처리
            ...
            imputer = SimpleImputer(
                ...
                output_column=col,
                output_path=f'./imputer_model/13_image/imputer_model_{col}',
