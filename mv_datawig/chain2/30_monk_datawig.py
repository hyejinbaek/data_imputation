...
# CSV 파일 경로 설정
result_csv_path = '/userHome/userhome2/hyejin/test/res/chain2/30_monk_datawig_method_res.csv'
...
def main():
    ...
    prepro_data = '/userHome/userhome2/hyejin/test/00_dataset/preprocessing/30_monk.csv'
    prepro_data = pd.read_csv(prepro_data)

    data_pth = '/userHome/userhome2/hyejin/test/00_dataset/missing/30_monk.csv'
    df_data = pd.read_csv(data_pth)
    train_col = ['a1', 'a2', 'a3','a4','a5', 'a6']
    ...
    for i in range(num_iterations):
        ...
        for col in train_col:
            ...
            imputer = SimpleImputer(
                ...
                output_column=col,
                output_path=f'./imputer_model/30_monk/imputer_model_{col}',
