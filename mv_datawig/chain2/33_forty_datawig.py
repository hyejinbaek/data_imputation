...
# CSV 파일 경로 설정
result_csv_path = '/userHome/userhome2/hyejin/test/res/chain2/33_forty_datawig_method_res.csv'
...
def main():
    ...
    prepro_data = '/userHome/userhome2/hyejin/test/00_dataset/preprocessing/33_forty.csv'
    prepro_data = pd.read_csv(prepro_data)

    data_pth = '/userHome/userhome2/hyejin/test/00_dataset/missing/33_forty.csv'
    ...
    for i in range(num_iterations):
        ...
        for col in train_col:
            ...
            imputer = SimpleImputer(
                ...
                output_column=col,
                output_path=f'./imputer_model/33_forty/imputer_model_{col}',
