...
# CSV 파일 경로 설정
result_csv_path = '/userHome/userhome2/hyejin/test/res/chain2/28_haberman_datawig_method_res.csv'
...
def main():
    ...
    prepro_data = '/userHome/userhome2/hyejin/paper_implementation/00_dataset/preprocessing/28_haberman.csv'
    prepro_data = pd.read_csv(prepro_data)

    data_pth = '/userHome/userhome2/hyejin/paper_implementation/00_dataset/missing/28_haberman.csv'
    df_data = pd.read_csv(data_pth)
    df_data.columns = ['age', 'oper', 'positive', 'class']
    ...
    for i in range(num_iterations):
        ...
        for col in train_col:
            ...
            imputer = SimpleImputer(
                ...
                output_column=col,
                output_path=f'./imputer_model/28_haberman/imputer_model_{col}',
