...
# CSV 파일 경로 설정
result_csv_path = '/userHome/userhome2/hyejin/test/res/chain2/29_echocardiogram_datawig_method_res.csv'
    ...
    for i in range(num_iterations):
        ...
        for col in train_col:
            ...
            imputer = SimpleImputer(
                ...
                output_column=col,
                output_path=f'./imputer_model/29_echocardiogram/imputer_model_{col}',
