...
# CSV 파일 경로 설정
result_csv_path = '/userHome/userhome2/hyejin/test/res/chain2/19_contraceptive_datawig_method_res.csv'
    ...
    for iteration in range(num_iterations):
        ...
        for i, col in enumerate(train_col):
            ...
            imputer = SimpleImputer(
                ...
                output_column=col,
                output_path=f'./imputer_model/19_contraceptive/imputer_model_{col}',
